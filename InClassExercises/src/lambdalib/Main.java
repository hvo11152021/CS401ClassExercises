...
public class Main {
	public static void main(String[] args) {
		...
		public static void prob1() {
			...
			System.out.println(LambdaLibrary.PROB1.apply(list, 55000, 120000));
		...
		public static void prob2() {
			...
			System.out.println(LambdaLibrary.PROB2.apply(list, 2011));
		}
		// Create a Lambda Library entry that does the following:
		...
		public static void prob3() {
			//Use this list
			List<Transaction> list = TraderTransactTestData.getTransactions();  
			System.out.println(LambdaLibrary.PROB3.apply(list, "Cambridge"));
